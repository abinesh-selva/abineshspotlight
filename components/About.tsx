              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full md:w-[calc(50%-2.5rem)] ${isRight ? 'md:pr-10' : 'md:pl-10'} pl-10 sm:pl-12 md:pl-0 pb-8 sm:pb-12`}>
                    <div className="border border-canvas/10 hover:border-accent/40 bg-canvas/5 p-4 sm:p-6 transition-all duration-300 group rounded-xl">
                      <div className="flex items-center justify-between mb-3 sm:mb-4 flex-wrap gap-2">
                        ...
                        <span className="text-xs font-mono text-canvas/40">
                          {item.year} — {item.end}
                        </span>
                      </div>
                  ...
                  <div className="absolute left-0 md:left-1/2 md:-translate-x-1/2 flex flex-col items-center">
                    <div className={`w-8 h-8 rounded-full border-2 border-ink ${style.dot} flex items-center justify-center shadow-sm`}>
