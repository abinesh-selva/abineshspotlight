...
export default function Nav() {
  ...
  return (
    <>
      ...
      {/* Mobile overlay */}
      <div id="mobile-nav" className={`fixed inset-0 z-40 flex flex-col items-center justify-center px-6 bg-ink${menuOpen ? ' is-open' : ''}`} aria-hidden={!menuOpen} role="dialog" aria-label="Mobile navigation">
