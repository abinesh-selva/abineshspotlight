    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 md:px-12 h-16 md:h-20 flex items-center justify-between">
          ...
          <a
            ...
            className="hidden md:inline-flex items-center gap-2 px-5 py-2 border border-rule text-sm font-bold text-white bg-forest hover:bg-accent hover:text-forest transition-all z-50"
          >
            Resume
          </a>
      ...
      >
        ...
        <a
          ...
          rel="noopener noreferrer"
          onClick={close}
          className="group mobile-nav-link inline-flex items-center gap-3 px-8 py-4 border border-canvas border-opacity-20 text-sm font-bold text-canvas hover:text-accent hover:border-accent transition-all"
        >
          View Resume
